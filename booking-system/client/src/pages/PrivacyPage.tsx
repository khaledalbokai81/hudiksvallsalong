  ...
  return (
    <section className="mx-auto max-w-4xl px-5 py-12 lg:px-8">
      ...
      <div className="mt-8 space-y-6 leading-7 text-slate-600">
        <p>
          {settings.businessName || templateConfig.business.name} uses booking information to respond to service
        ...
        {settings.legal.privacyContactEmail && <section><h2 className="text-xl font-bold text-ink">Privacy contact</h2><p className="mt-2">Questions about personal information can be sent to <a className="font-semibold text-ink underline" href={`mailto:${settings.legal.privacyContactEmail}`}>{settings.legal.privacyContactEmail}</a>.</p></section>}
        {settings.legal.cancellationPolicy && <section><h2 className="text-xl font-bold text-ink">Cancellation policy</h2><p className="mt-2 whitespace-pre-line">{settings.legal.cancellationPolicy}</p></section>}
        <section>
