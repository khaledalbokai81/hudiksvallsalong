...
export function LeadTracker({ summary }: LeadTrackerProps) {
  ...
  return (
    ...
    <section className="md:hidden">
      <div className="rounded-xl border border-[#e1d8c5] bg-white shadow-sm">
        <div className="px-3 py-3 text-sm font-bold text-[#171614]">
          Pipeline insights
          <span className="float-right text-xs font-semibold text-[#8a7652]">Overview</span>
        </div>
        <div className="border-t border-[#eee7d8] p-3">
