...
export default function Home() {
  const localBusinessSchema = {
    ...
    telephone: "+46720147022", priceRange: "$$",
  ...
  return <main>
    ...
    <section className="hero" id="top" aria-labelledby="hero-title">
      <div className="hero-copy">
        ...
        <a className="button hero-booking" href="tel:+46720147022">Ring oss <Arrow /></a>
    ...
    <section className="reviews section" aria-labelledby="reviews-title" data-reveal><div className="section-heading"><p className="eyebrow">Hudiksvalls Salong</p><h2 id="reviews-title">Ett val kunder<br/>valjer igen.</h2></div><div className="review-grid achievements-grid"><figure><blockquote>50+</blockquote><figcaption>Google-recensioner</figcaption><p>Starka omdomen fran kunder som har besokt salongen.</p></figure><figure><blockquote>Stammisar</blockquote><figcaption>Aterkommande kunder</figcaption><p>Manga kunder valjer att komma tillbaka, gang efter gang.</p></figure><figure><blockquote><CountUp end={10} />+ &aring;r</blockquote><figcaption>I Hudiksvall</figcaption><p>Erfarenhet, hantverk och personlig service mitt i stan.</p></figure></div></section>

    <section className="booking" id="drop-in" aria-labelledby="drop-in-title" data-reveal><div className="booking-intro"><p className="eyebrow">Ingen tidsbokning</p><h2 id="drop-in-title">Kom förbi<br/>när det passar.</h2><p className="booking-lead">Vi arbetar med drop-in. Välkommen in under våra öppettider.</p></div><div className="booking-card"><p className="eyebrow">Drop-in</p><h3>Din stil,<br/><em>när du vill.</em></h3><a className="button" href="tel:+46720147022">Ring oss <Arrow /></a><div className="booking-card-contact"><span>Har du frågor?</span><a href="tel:+46720147022">Ring 072&ndash;014 70 22</a></div><small>I mån av tid</small></div></section>
