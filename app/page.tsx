...
export default function Home() {
  ...
  return <main>
    ...
    <section className="local-faq" aria-labelledby="faq-title" data-reveal><div><p className="eyebrow">Bra att veta</p><h2 id="faq-title">Vanliga frågor</h2><p>Snabba svar inför ditt besök hos Hudiksvalls Salong.</p></div><div className="faq-list"><details><summary>Behöver jag boka tid?</summary><p>Nej, vi arbetar främst med drop-in. Vill du vara säker på en viss tid kan du ringa <a href={`tel:${business.phoneHref}`}>{business.phoneDisplay}</a> i förväg.</p></details><details><summary>Vilka tjänster erbjuder ni?</summary><p>Klippning för herr, pensionär, student och barn under 9 år samt skäggtrimning. Se hela <a href="/tjanster">prislistan och våra tjänster</a>.</p></details><details><summary>Var ligger salongen?</summary><p>Du hittar oss på Kungsgatan 14 i centrala Hudiksvall. Vi välkomnar även kunder från Ljusdal och andra närliggande orter.</p></details><details><summary>Vilket språk talar ni?</summary><p>Servicen i salongen sker på svenska.</p></details></div></section>
